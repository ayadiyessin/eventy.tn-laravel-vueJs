                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ms-auto">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="prenom" v-model="participant.prenom_part"
                                        required />
                                </div>
                            </div>
                        </div>
...
const getpart = async () => {
    await api.get(`/api/Partic/${userId.value}`)
        .then(res => {
            participant.value = res.data[0]
        })
        .catch(error => {
            console.log(error)
        })
...
const modifierUser = async () => {
    try {
        ...
        await api.put(`/api/Participants/${participant.value.id}`, participant.value);
